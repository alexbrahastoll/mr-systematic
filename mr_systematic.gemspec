...
Gem::Specification.new do |spec|
  spec.name          = "mr_systematic"
  spec.version       = MrSystematic::VERSION
  spec.authors       = ["Alex Braha Stoll"]
  spec.email         = ["alexbrahastoll@gmail.com"]

  spec.summary       = %q{A gem to help researchers generate systematic review forms from BibTeX files.}
  ...
  spec.add_runtime_dependency 'bibtex-ruby', '~> 4.4', '>= 4.4.7'
end
